          ...
          >
            <div class="bg-white rounded-[1.75rem] border border-gray-200/60 overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-500">
              ...
              <div class="p-7 lg:p-9">
                ...
                <!-- CTA -->
                <NuxtLink :to="localePath('/contact')" class="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gray-900 text-white text-[14px] font-medium font-inter hover:bg-gray-800 transition-all group">
                  {{ $t('nav.contact') }}
