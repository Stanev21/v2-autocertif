  ...
  <section class="py-16 sm:py-24 lg:py-32 bg-[#0B1426] relative overflow-hidden">
    ...
    <div class="relative max-w-3xl mx-auto px-4 sm:px-8 lg:px-12 text-center">
      ...
      <div class="flex items-center justify-center gap-4 flex-wrap mb-6">
        <button class="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-coral text-white text-[15px] font-semibold font-inter hover:bg-coral-dark transition-all cursor-pointer shadow-[0_0_40px_rgba(59,130,246,0.3)]">
          {{ $t('affiliate.cta') }}
