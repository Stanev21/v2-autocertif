<template>
  <section class="py-16 sm:py-24 lg:py-32 bg-[#0B1426] relative overflow-hidden">
    <!-- Gradient orbs -->
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] rounded-full opacity-[0.12] blur-[120px]" style="background: radial-gradient(circle, #3B82F6 0%, transparent 70%);"></div>
    ...
    <div class="relative max-w-3xl mx-auto px-4 sm:px-8 lg:px-12 text-center">
      <h2 class="text-[1.75rem] sm:text-[2.25rem] lg:text-[3rem] font-normal text-white leading-[1.08] font-heading mb-5">
        {{ $t('affiliate.ctaBannerTitle') }}
      </h2>
      <p class="text-white/45 text-[16px] leading-[1.7] font-inter mb-10 max-w-xl mx-auto">
        {{ $t('affiliate.ctaBannerDesc') }}
      </p>

      <div class="flex items-center justify-center gap-4 flex-wrap mb-6">
        <NuxtLink :to="localePath('/contact')" class="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-coral text-white text-[15px] font-semibold font-inter hover:bg-coral-dark transition-all cursor-pointer shadow-[0_0_40px_rgba(59,130,246,0.3)]">
          {{ $t('affiliate.cta') }}
