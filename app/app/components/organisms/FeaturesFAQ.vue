      ...
      <div class="grid lg:grid-cols-5 gap-8 sm:gap-12 lg:gap-20">
        ...
        <div class="lg:col-span-2">
          <div class="lg:sticky lg:top-40">
            ...
            <NuxtLink :to="localePath('/')" class="group inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gray-900 text-white text-[14px] font-medium font-inter hover:bg-gray-800 transition-all cursor-pointer">
              {{ $t('features.cta') }}
