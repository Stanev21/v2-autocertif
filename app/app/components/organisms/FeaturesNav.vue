  ...
  <nav class="sticky top-[3.75rem] md:top-16 lg:top-20 z-40 border-b border-gray-200/50 bg-white/80 backdrop-blur-xl transition-all duration-300"
    ...
    <div class="max-w-[1280px] mx-auto px-4 sm:px-8 lg:px-12">
      <div class="flex items-center justify-between h-14">
        ...
        <button class="hidden md:inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gray-900 text-white text-[13px] font-medium font-inter hover:bg-gray-800 transition-all cursor-pointer">
          {{ $t('features.cta') }}
