      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        >
          ...
          <div class="w-12 h-12 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"
            :class="hoveredTopic === i ? 'bg-teal-500 text-white' : 'bg-gray-100 text-gray-400'"
          >
          ...
          <h3 class="text-[1rem] font-inter font-semibold text-gray-900 mb-2 group-hover:text-teal-700 transition-colors">
            {{ topic.title }}
          </h3>
