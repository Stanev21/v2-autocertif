  ...
  <section class="py-16 sm:py-24 lg:py-32 bg-[#0A1020] relative overflow-hidden">
    ...
    <div class="relative max-w-3xl mx-auto px-4 sm:px-8 lg:px-12 text-center">
      ...
      <div class="flex items-center justify-center gap-4 flex-wrap">
        <NuxtLink :to="localePath('/')" class="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-coral text-white text-[15px] font-semibold font-inter hover:bg-coral-dark transition-all cursor-pointer shadow-[0_0_40px_rgba(59,130,246,0.3)]">
          {{ $t('about.ctaCta') }}
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" /></svg>
        </NuxtLink>
        <NuxtLink :to="localePath('/business')" class="inline-flex items-center gap-2 px-8 py-4 rounded-full border border-white/20 text-white text-[15px] font-medium font-inter hover:bg-white/[0.06] transition-all cursor-pointer">
          {{ $t('about.ctaBusiness') }}
        </NuxtLink>
      </div>
    </div>
