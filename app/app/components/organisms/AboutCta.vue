<template>
  <section class="py-24 lg:py-32 bg-[#0a0a0a] relative overflow-hidden">
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full opacity-[0.1] blur-[120px]" style="background: radial-gradient(circle, #CD3246 0%, transparent 70%);"></div>
    ...
    <div class="relative max-w-3xl mx-auto px-8 lg:px-12 text-center">
      ...
      <div class="flex items-center justify-center gap-4 flex-wrap">
        <button class="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-coral text-white text-[15px] font-semibold font-inter hover:bg-coral-dark transition-all cursor-pointer shadow-[0_0_40px_rgba(205,50,70,0.3)]">
          {{ $t('about.ctaCta') }}
